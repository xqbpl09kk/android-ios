...
// MARK： 从 https://github.com/h0tk3y/kotlin-fun 项目移植过来的版本
 ...
 * provide the initial value. The slim [initializer] throws [IllegalStateException].
 */
 ...
 *
 * If the delegated property of an [R] instance is accessed but has not been initialized, [initializer] is called to
 * provide the initial value. The slim [initializer] returns `null`.
 */
