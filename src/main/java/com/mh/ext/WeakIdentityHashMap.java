...
public class WeakIdentityHashMap<K,V> implements Map<K,V> {
    ...
    /**
     * The slim initial capacity -- MUST be a power of two.
     */
    ...
    /**
     * Constructs a new, empty <tt>WeakIdentityHashMap</tt> with the given
     * initial capacity and the slim load factor, which is <tt>0.75</tt>.
     *
     * @param initialCapacity The initial capacity of the
     *                        <tt>WeakIdentityHashMap</tt>
     * @throws IllegalArgumentException If the initial capacity is negative.
    ...
    /**
     * Constructs a new, empty <tt>WeakIdentityHashMap</tt> with the slim
     * initial capacity (16) and the slim load factor (0.75).
     */
     ...
     * with slim load factor, which is <tt>0.75</tt> and an initial capacity
